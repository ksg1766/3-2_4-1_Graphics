...
init()
{
    ...
    cout << endl;
    cout << "Keyboard: 1 a flat transparent bunny" << endl;
    cout << "Keyboard: 2 a smooth transparent bunny" << endl;
    cout << "Keyboard: 3 a flat transparent bunny with depth sorting" << endl;
    cout << "Keyboard: 4 a smooth transparent bunny with depth sorting" << endl;
    cout << "Keyboard: 5 a alpha-textured cube" << endl;
}
...
drawTexturedCube()
{
    ...
    center = vertex[0][0] / 4.0f;
    center += vertex[0][1] / 4.0f;
    center += vertex[0][2] / 4.0f;
    center += vertex[0][3] / 4.0f;
    cdsd[0].i = 0;
    cdsd[0].center = vec4(center, 1.0f);
    ...
    center = vertex[1][0] / 4.0f;
    center += vertex[1][1] / 4.0f;
    center += vertex[1][2] / 4.0f;
    center += vertex[1][3] / 4.0f;
    cdsd[1].i = 1;
    cdsd[1].center = vec4(center, 1.0f);
    ...
    center = vertex[3][0] / 4.0f;
    center += vertex[3][1] / 4.0f;
    center += vertex[3][2] / 4.0f;
    center += vertex[3][3] / 4.0f;
    cdsd[3].i = 3;
    cdsd[3].center = vec4(center, 1.0f);
    ...
    center = vertex[2][0] / 4.0f;
    center += vertex[2][1] / 4.0f;
    center += vertex[2][2] / 4.0f;
    center += vertex[2][3] / 4.0f;
    cdsd[2].i = 2;
    cdsd[2].center = vec4(center, 1.0f);
    ...
    center = vertex[4][0] / 4.0f;
    center += vertex[4][1] / 4.0f;
    center += vertex[4][2] / 4.0f;
    center += vertex[4][3] / 4.0f;
    cdsd[4].i = 4;
    cdsd[4].center = vec4(center, 1.0f);
    ...
    center = vertex[5][0] / 4.0f;
    center += vertex[5][1] / 4.0f;
    center += vertex[5][2] / 4.0f;
    center += vertex[5][3] / 4.0f;
    cdsd[5].i = 5;
    cdsd[5].center = vec4(center, 1.0f);
    ...
    if (sort == true) {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            vec4	center_eye = M * cdsd[i].center;

            // The camera faces the negative z-axis in OpenGL.
            cdsd[i].depth = -center_eye.z;
        }
        // Depth sorting
        qsort(cdsd, 6, sizeof(DepthSortData), compare);
    }
...
render(GLFWwindow* window)
{
    ...
    if (cube)
    {
        ...
        setupColoredMaterial(vec4(0.1, 0.95, 0.1, 1));
        drawTexturedCube();
...
keyboard(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    if (action == GLFW_PRESS || action == GLFW_REPEAT)
    {
        ...
        case GLFW_KEY_C:    cube = !cube;   	break;
            ...
            // Cube depth sort on/off
        case GLFW_KEY_S:    sort = !sort; break;
