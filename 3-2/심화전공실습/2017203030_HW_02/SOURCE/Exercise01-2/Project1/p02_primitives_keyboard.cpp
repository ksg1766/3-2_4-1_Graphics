...
render(GLFWwindow* window)
{
	...
	glBegin(mode);
	{
		glColor3f(1, 0, 0);	glVertex2f(-0.7, -0.25);
		glColor3f(0.5, 0.5, 0);	glVertex2f(-0.5, 0.25);//
		glColor3f(0, 1, 0);	glVertex2f(-0.3, -0.25);
		glColor3f(0, 0.5, 0.5);	glVertex2f(-0.1, 0.25);//
		glColor3f(0, 0, 1);	glVertex2f(0.1, -0.25);
		glColor3f(0, 0, 0.5);	glVertex2f(0.3, 0.25);//
		glColor3f(0, 0, 0);	glVertex2f(0.5, -0.25);
		glColor3f(0.5, 0, 0);	glVertex2f(0.7, 0.25);//
	}
	glEnd();
}
